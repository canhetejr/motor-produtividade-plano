...
export function FormularioBuilderDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl max-h-[90dvh] flex flex-col p-0 gap-0 overflow-hidden rounded-md border border-border bg-background shadow-2xl">
        <DialogHeader className="border-b border-border bg-card p-5 pb-4">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-primary/10 text-primary shadow-inner">
...
function FormularioBuilderForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0 overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-border bg-card px-5 pt-3">
      ...
      <div className="flex-1 overflow-y-auto p-5">
        ...
        {activeTab === 'campos' && (
          <div className="space-y-4">
            {/* Quick Presets Bar */}
            <div className="rounded-md border border-border/80 bg-muted/40 p-3.5 space-y-2">
            ...
            <div className="space-y-3">
              {campos.map((campo, index) => {
                ...
                return (
                  <div
                    key={campo.localId}
                    className="group relative rounded-md border border-border bg-card p-4 space-y-3 shadow-xs hover:border-primary/40 transition-all"
                  >
        ...
        {activeTab === 'preview' && (
          <div className="space-y-4">
            ...
            <div className="max-w-md mx-auto rounded-md border border-border bg-card shadow-xl overflow-hidden">
              ...
              <div className="p-6 space-y-5">
                ...
                <button
                  type="button"
                  disabled
                  className="w-full py-2.5 rounded-md font-semibold text-xs text-white shadow-md transition-opacity opacity-90"
