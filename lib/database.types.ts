    ...
    Tables: {
      ...
      automacoes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "automacoes_quadro_id_fkey"
            columns: ["quadro_id"]
            isOneToOne: false
      ...
      cartoes_anexos: {
        ...
        Relationships: [
          {
            foreignKeyName: "cartoes_anexos_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      cartoes_aprovacoes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "cartoes_aprovacoes_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      cartoes_campos_valores: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "cartoes_campos_valores_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      cartoes_checklist_itens: {
        ...
        Relationships: [
          {
            foreignKeyName: "cartoes_checklist_itens_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      cartoes_emails: {
        ...
        Relationships: [
          {
            foreignKeyName: "cartoes_emails_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      cartoes_predecessores: {
        ...
        Relationships: [
          {
            foreignKeyName: "cartoes_predecessores_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      cartoes_requisitos_status: {
        ...
        Relationships: [
          {
            foreignKeyName: "cartoes_requisitos_status_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      cartoes_seguidores: {
        ...
        Relationships: [
          {
            foreignKeyName: "cartoes_seguidores_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      cartoes_sequencia_responsaveis: {
        ...
        Relationships: [
          {
            foreignKeyName: "cartoes_sequencia_responsaveis_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      cartoes_sessoes_tempo: {
        ...
        Relationships: [
          {
            foreignKeyName: "cartoes_sessoes_tempo_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      colunas_requisitos: {
        ...
        Relationships: [
          {
            foreignKeyName: "colunas_requisitos_coluna_id_fkey"
            columns: ["coluna_id"]
            isOneToOne: false
            referencedRelation: "colunas"
            referencedColumns: ["id"]
      ...
      google_calendar_eventos: {
        ...
        Relationships: [
          {
            foreignKeyName: "google_calendar_eventos_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
            referencedRelation: "cartoes"
            referencedColumns: ["id"]
      ...
      google_workspace_conexoes: {
        ...
        Relationships: [
          {
            foreignKeyName: "google_workspace_conexoes_colaborador_id_fkey"
            columns: ["colaborador_id"]
            isOneToOne: true
            referencedRelation: "colaboradores"
            referencedColumns: ["id"]
      ...
      quadros_campos: {
        ...
        Relationships: [
          {
            foreignKeyName: "quadros_campos_quadro_id_fkey"
            columns: ["quadro_id"]
            isOneToOne: false
            referencedRelation: "quadros"
            referencedColumns: ["id"]
